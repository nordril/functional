...
namespace Nordril.Functional.Algebra
{
    ...
    {
        /// <summary>
        /// The additive operation. This must be an alias of <see cref="IHasMagma{T}.Op(T)"/> of the first monoid.
        /// </summary>
        /// <param name="y">The second operand.</param>
        T Plus(T y);

        /// <summary>
        /// The additive operation. This must be an alias of <see cref="IHasMagma{T}.Op(T)"/> of the second monoid.
        /// </summary>
        /// <param name="y">The second operand.</param>
        T Mult(T y);

        /// <summary>
        /// The multiplicative neutral element. This must be an alias of <see cref="IHasMonoid{T}.Neutral"/> of the second monoid.
        /// </summary>
        T One { get; }

        /// <summary>
        /// The additive neutral element. This must be an alias of <see cref="IHasMonoid{T}.Neutral"/> of the first monoid.
        /// </summary>
        T Zero { get; }
    }
}
